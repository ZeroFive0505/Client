...
CMisuzuBlock::CMisuzuBlock(CRCGEnemy* npc, CState* nextState) :
	CState(npc, nextState)
{
	m_State = STATE::BLOCK;
}

CMisuzuBlock::~CMisuzuBlock()
{
}

void CMisuzuBlock::Enter()
{
...
bool CMisuzuBlock::BlockEndCondition()
{
